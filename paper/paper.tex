...
\begin{verbatim}
 ...
 40.93   18.00   51000000   DES::mixer()
 22.88   10.06   16000000   DES::f()
 20.17    8.87    1000000   DES::keyschedule()
  8.20    3.60    1000000   DES::algorithm()
  5.59    2.46  512000000   DES::get()
  0.61    0.27   32000000   std::swap<T>()
  0.53    0.23    1000000   std::swap_ranges<T,G>()
  0.41    0.18   32000000   std::__iter_swap<T>::iter_swap<G,E>()
  0.28    0.12   32000000   std::iter_swap<T,G>()
  0.20    0.09              DES::on()
  0.11    0.05    1000000   DES::DES()
  0.02    0.01    1000000   DES::encrypt()
  0.02    0.01    1000000   DES::~DES()
  0.02    0.01              DES::main
\end{verbatim}
